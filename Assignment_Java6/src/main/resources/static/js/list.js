...
$(document).ready(function () {
  ...
  var fromPriceInput = document.querySelector('.fromPrice');
  var toPriceInput = document.querySelector('.toPrice');

  var fromPrice = fromPriceInput && fromPriceInput.value ? parseInt(fromPriceInput.value) : 0;
  var toPrice = toPriceInput && toPriceInput.value ? parseInt(toPriceInput.value) : 5000000;

  fromPrice = isNaN(fromPrice) ? 0 : fromPrice;
  toPrice = isNaN(toPrice) ? 5000000 : toPrice;
